...
" XXX support for back-tilde strings
syn region  javaScriptStringP	       start=+`+  skip=+\\\\\|\\`+  end=+`+	contains=javaScriptSpecial,@htmlPreproc
...
syn keyword javaScriptIdentifier	arguments this var let const await async
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink javaScriptStringP		String
